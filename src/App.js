        ...
        <div className="generator">
          ...
          <div className="generator__password">
            ...
            <button className="copy__btn">
              <i class="far fa-clipboard" onClick={handleCopyPassword}></i>
            </button>
          </div>
          <div className="form-group">
            <label htmlFor="password-strength">Password length</label>
            <input className="pw" defaultValue={passwordLength} onChange={(e) => setPasswordLength(e.target.value)} type="number" id="password-stregth" name="password-strength" max="20" min="8" />
          </div>
          <div className="form-group">
